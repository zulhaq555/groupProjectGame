...
public class Vampire extends Enemy{
    ...
    public Vampire(TileMap tm) {
        ...
        try{
            ...
            texture[WALKRIGHT].loadFromFile(Paths.get("src/com/resources/images/enemies/vampireSprites/vampireRight.png"));
            texture[WALKLEFT].loadFromFile(Paths.get("src/com/resources/images/enemies/vampireSprites/vampireLeft.png"));
